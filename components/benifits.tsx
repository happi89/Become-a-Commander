        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            <h2 className="text-4xl font-bold mb-4">
              Step Into a World of Privilege
            </h2>
            <p className="text-xl text-gray-600">
              Becoming a Commander in Gilead opens the door to a life
              of influence, prestige, and unparalleled privilege. Here
              are a few reasons why donning the Commander&apos;s mantle is
              a pursuit of distinction:
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm items-start gap-6 md:max-w-2xl md:grid-cols-2 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                As a Commander, you become a key decision-maker in our
                society, shaping policies and influencing the future
                of Gilead.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                The title of Commander commands respect and
                admiration. Your status as a leader is recognized and
                revered by all.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                Enjoy access to luxuries and conveniences reserved
                exclusively for our esteemed Commanders.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                Join a community of like-minded individuals committed
                to upholding the values and vision of Gilead.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                Leave a lasting legacy by contributing to the greater
                good of our society.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <p className="text-center text-gray-600">
                Gain unique insight and power to contribute to
                Gilead&apos;s prosperity as a Commander. The power to
