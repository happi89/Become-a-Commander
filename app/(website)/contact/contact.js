...
export default function Contact({ settings }) {
  ...
  const apiKey =
    settings?.w3ckey || "bc98b844-3864-407f-af34-cc9db63a7097";

  const { submit: onSubmit } = useWeb3Forms({
    access_key: apiKey,
    settings: {
      from_name: "Become a Commander",
      subject: "New Contact Message from Become a Commander Website"
    },
    onSuccess: (msg, data) => {
      setIsSuccess(true);
      setMessage(msg);
  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">
          We are a here to help you Become a Commander!
        </p>
      </div>
        ...
        <div className="my-10">
          ...
          <div className="mt-5">
            <div className="text-dark-600 mt-2 flex items-center space-x-2 dark:text-gray-400">
              ...
              <span>
                3545 Morning Star Dr Mississauga Ontario L4T1Y3
              </span>
            </div>
            {settings?.email && (
              <div className="text-dark-600 mt-2 flex items-center space-x-2 dark:text-gray-400">
